...
module.exports = {
  ...
  prompt: {
    ...
    types: [
      ...
      {
        value: "style",
        name: "style:    🎨  Changes that do not affect the meaning of the code | 代码格式（不影响功能，例如空格、分号等格式修正）",
        emoji: "🎨"
      },
      {
        value: "refactor",
      ...
      {
        value: "perf",
        name: "perf:     ⚡️  A code change that improves performance | 性能优化",
        emoji: "⚡️"
      },
      {
        value: "test",
      ...
      {
        value: "chore",
        name: "chore:    🔨  Other changes that don't modify src or test files | 对构建过程或辅助工具和库的更改（不影响源文件、测试用例）",
        emoji: "🔨"
      },
      {
        value: "revert",
        name: "revert:   ⏪️  Reverts a previous commit | 回滚 commit",
        emoji: "⏪️"
      },
      {
        value: "wip",
        name: "wip:      🕔  work in process | 正在开发中",
        emoji: "🕔"
      },
      {
        value: "workflow",
        name: "workflow: 📋  workflow improvements | 工作流程改进",
        emoji: "📋"
      },
      // 中文版
